...
CREATE TABLE `execution_flows` (
  ...
  KEY `project_id` (`project_id`,`flow_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `execution_flows`
--

LOCK TABLES `execution_flows` WRITE;
/*!40000 ALTER TABLE `execution_flows` DISABLE KEYS */;
/*!40000 ALTER TABLE `execution_flows` ENABLE KEYS */;
UNLOCK TABLES;
